...
let anchorElement= document.getElementById("external_link"); /* via element ID accesing with this build in option and sotring it in a variable */
anchorElement.href = 'https;//google.com' /* assigning link to the element */

document.querySelector('#external-id'); /* via CSS selector or vy element type lie 'a' o 'p a' selecting first matching element */
anchorElement.href = 'https;//google.com' /* assigning link to the element */
...
let firstParagraph = document.querySelector('p'); /* it will find the 1st paragrph in the page */
