...
console.log (enteredText) /* every time you type the console.log print what your wrote */
console.log(event)
 }

 typedInput.addEventListener('input',detectedTyping); /* input propety applies for eanything done insed the imput element "Key" is not enough */
